...
export default function InfrastructurePage() {
  ...
  const integrations: IntegrationInfo[] = [
    ...
    },
    {
      name: 'Replicate/Flux',
      type: 'api',
      description: 'AI image generation for blog post featured images',
      when: 'On-demand when generating posts',
      why: 'Consistent Marshall visuals',
      status: 'active',
    ...
    },
    {
      ...
      type: 'api',
      description: 'Weather data for tournament locations (temperature, conditions, forecast)',
      when: 'When generating travel/tournament posts or lifestyle content',
      why: 'Real weather data for grounded content',
      status: 'active',
      envVar: 'OPENWEATHER_API_KEY',
      notes: 'Cached 6 hours. Free tier available. Falls back to mock data.',
    },
    {
    ...
    },
    {
      name: 'Gear Data',
      type: 'database',
      description: 'Racket, shoe, and gear information with affiliate links',
      when: 'When generating gear reviews or recommendations',
      why: 'Gear data for affiliate revenue',
      status: 'active',
      notes: 'Manual database entries or scraped. Cached 24 hours.',
    },
    {
