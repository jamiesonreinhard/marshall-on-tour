 ...
 * - Large featured post on left (60% width)
 * - Latest posts sidebar on right (40% width)
 * - All content visible above the fold
 */
export default async function HomeVariant1() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero + Featured Posts Section - All Above Fold */}
      <section className="max-w-[1600px] mx-auto px-6 sm:px-8 py-12 sm:py-16">
        <div className="grid lg:grid-cols-5 gap-8 lg:gap-12">
          {/* Featured Post - Large (60%) */}
          <div className="lg:col-span-3 space-y-6">
            {featuredPost ? (
              <Link href={`/blog/${featuredPost.slug}`} className="group block">
                <article className="space-y-4">
                  <div className="aspect-[4/3] relative rounded-2xl overflow-hidden bg-zinc-100 shadow-lg">
                    <Image
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-8">
                      ...
                      <h1 className="text-3xl sm:text-4xl font-bold text-white mb-3 group-hover:text-amber-100 transition-colors">
                        {featuredPost.title}
                      </h1>
              ...
              <div className="aspect-[4/3] relative rounded-2xl overflow-hidden bg-zinc-100 flex items-center justify-center">
                <p className="text-zinc-500">No posts yet</p>
              </div>
            )}

            {/* Intro Text Below Featured */}
            <div className="space-y-4 pt-4">
              <h2 className="text-2xl font-bold text-zinc-900">The Tour, from the Inside</h2>
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-lg font-semibold text-zinc-900">Latest</h3>
              <Link
                href="/blog"
            ...
            {sidebarPosts.length > 0 ? (
                ...
                {sidebarPosts.map((post) => (
                  ...
                  >
                    <article className="flex gap-4">
                      <div className="w-24 h-24 flex-shrink-0 relative rounded-lg overflow-hidden bg-zinc-100">
                        <Image
                      ...
                      <div className="flex-1 min-w-0 space-y-1">
                        ...
                        <h3 className="text-base font-semibold text-zinc-900 group-hover:text-zinc-600 transition-colors line-clamp-2">
                          {post.title}
                        </h3>
              ...
              <p className="text-zinc-500 text-sm">More posts coming soon</p>
            )}
